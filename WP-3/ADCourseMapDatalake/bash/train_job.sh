...
srun python /home/IFAB/WORK/ADCourseMap/code/main.py --n_iter 200 --device cpu --level merged_comb --file_code FINALMERGE_FSVERSION_4-3_METHOD_CSF_elecsys_METHOD_PET_FBP --n_burn_in_iter_frac 0.6 --burn_in_step_power 0.8 --source_dimension 3
