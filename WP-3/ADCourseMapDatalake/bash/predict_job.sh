...
#SBATCH --output=/home/IFAB/WORK/ADCourseMap/results/ADCourseMap_predict_%j.out
#SBATCH --error=/home/IFAB/WORK/ADCourseMap/results/ADCourseMap_predict_%j.err
...
srun python /home/IFAB/WORK/ADCourseMap/code/main.py --level cleaned_03 --device cpu --file_code ADNIMERGE_PT_2_3 --prediction_timepoints_start 75 --prediction_timepoints_end 80 --prediction_timepoints_step 1 --prediction True
